...
public class TeAccount implements java.io.Serializable {
	...
	private static final long serialVersionUID = -3209609147407319450L;
	...
	/** full constructor */
	public TeAccount(Date creation, Integer type, Integer state, String username, String password, String nickname,
			String creator) {
